...
return (
  <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 text-left">
    ...
    <p className="text-gray-700 mb-6">Share demograhic information for your profile</p>
    ...
    <div className="flex flex-wrap -mx-2">
      ...
      <div className="w-full md:w-1/2 px-2 mb-4">
        <b>Location</b>
          <input type="text" className="w-full p-3 bg-gray-100 rounded-lg" value={location} onChange={(e) => setLocation(e.target.value)} />
      </div>
      ...
      <div className="w-full md:w-1/2 px-2 mb-4">
        <b>Job Title</b>
          <input type ="text" className="w-full p-3 bg-gray-100 rounded-lg" value={jobTitle} onChange={(e) => setJobTitle(e.target.value)} />
      </div>
    
      <div className="w-full md:w-1/2 px-2 mb-4">
        <b>Education</b>
          <input type ="text" className="w-full p-3 bg-gray-100 rounded-lg" value={education} onChange={(e) => setEducation(e.target.value)} />
      </div>
    </div>
