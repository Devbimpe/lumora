  ...
  return (
    <div className="w-full flex flex-col items-center gap-4">
      ...
      <div className="grid grid-cols-2 gap-4 h-100 w-5/6">
        <div className="bg-white border text-center p-4">1</div>
        <div className="bg-white border text-center p-4">2</div>
        <div className="bg-white border text-center p-4">3</div>
        <div className="bg-white border text-center p-4">4</div>
      </div>
    </div>
  );
}