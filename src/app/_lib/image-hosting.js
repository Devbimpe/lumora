...
/**
 * Uploads an image to Cloudinary from a LOCAL file path. The filename is optional, if not provided it will be generated by Cloudinary.
 * 
 * This should most likely not be used, as the server should not have access to local file paths, but it is here for completeness and testing purposes. 
